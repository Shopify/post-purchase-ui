...
export class UiTheme {
  ...
  preview(
    ...
    const colors = colorsFromOverrides(overrides);
...
function customPropertiesFromThemeConfiguration(
  ...
  const globalTypographyLineSizeLarge = maybeInMap(TYPOGRAPHY_LINE_SIZE_MAP)(
    global.typographyLineSizeLarge,
  );
  ...
  const linkTransitionDuration = maybeInMap(DURATION_MAP)(
